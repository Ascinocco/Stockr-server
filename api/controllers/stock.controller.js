    ...
    var feed = function(req, res, next)
    {
        ...
        if (symbols.length > 0) {
            ...
            var url = buildStockQueryString(symbols, {
                ...
                TODAYS_HIGHEST_BID: STOCK_FORMATER_KEYS.TODAYS_HIGHEST_BID,
                TODAYS_LOWEST_BID: STOCK_FORMATER_KEYS.TODAYS_LOWEST_BID,
                
                CHANGE_IN_PERCENT: STOCK_FORMATER_KEYS.CHANGE_IN_PERCENT,
                
                LAST_TRADE: STOCK_FORMATER_KEYS.LAST_TRADE,
                
                THIS_WEEKS_HIGHEST_PRICE: STOCK_FORMATER_KEYS.THIS_WEEKS_HIGHEST_PRICE,
                THIS_WEEKS_LOWEST_PRICE: STOCK_FORMATER_KEYS.THIS_WEEKS_LOWEST_PRICE,
                
                EARNINGS_PER_SHARE: STOCK_FORMATER_KEYS.EARNINGS_PER_SHARE,
                
                WEEKS_RANGE: STOCK_FORMATER_KEYS.WEEKS_RANGE,

                CHANGE_FROM_THIS_WEEKS_HIGH_IN_PERCENT: STOCK_FORMATER_KEYS.CHANGE_FROM_THIS_WEEKS_HIGH_IN_PERCENT,
                CHANGE_FROM_THIS_WEEKS_HIGH_IN_DECIMAL: STOCK_FORMATER_KEYS.CHANGE_FROM_THIS_WEEKS_HIGH_IN_DECIMAL,

                CHANGE_FROM_THIS_WEEKS_LOW_IN_PERCENT: STOCK_FORMATER_KEYS.CHANGE_FROM_THIS_WEEKS_LOW_IN_PERCENT,
                CHANGE_FROM_THIS_WEEKS_LOW_IN_DECIMAL: STOCK_FORMATER_KEYS.CHANGE_FROM_THIS_WEEKS_LOW_IN_DECIMAL
            });
